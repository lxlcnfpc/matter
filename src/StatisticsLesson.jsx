...
const StatisticsLesson = () => {
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-3xl">Descriptive Statistics: Location, Dispersion & Distribution</CardTitle>
          <p className="text-gray-600 mt-2">Interactive Manufacturing Quality Control Example</p>
        </CardHeader>
